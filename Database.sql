...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2023 at 03:53 PM
...
(28, 'male leather Shoe', 6, '9299', 'Male Formal-1.jpg', 'Male Leather Shoe Colour : Black');
...
--
ALTER TABLE `products`
  MODIFY `productID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
